...
static NCURSES_CONST char ** ptr_boolfnames = NULL;
...
static NCURSES_CONST char ** ptr_boolnames = NULL;
...
static NCURSES_CONST char ** ptr_numfnames = NULL;
...
static NCURSES_CONST char ** ptr_numnames = NULL;
...
static NCURSES_CONST char ** ptr_strfnames = NULL;
...
static NCURSES_CONST char ** ptr_strnames = NULL;
...
{
	if (*value == NULL) {
		if ((*value = typeCalloc(NCURSES_CONST char *, size + 1)) != NULL) {
			unsigned n;
			for (n = 0; n < size; ++n) {
