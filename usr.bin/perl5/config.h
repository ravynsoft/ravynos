 ...
 */
#define ARCHLIB "/usr/lib/perl5/5.38.2/amd64-freebsd"		/**/
#define ARCHLIB_EXP "/usr/lib/perl5/5.38.2/amd64-freebsd"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/lib/perl5/site_perl/5.38.2/amd64-freebsd"		/**/
#define SITEARCH_EXP "/usr/lib/perl5/site_perl/5.38.2/amd64-freebsd"		/**/
