...
#define	flSameCount	 (0x20) /* SamCount specified, used by co-bounded
                                 * arrays */
...
typedef struct ipc_type {
    ...
    u_int           itMinTypeSize;      /* minimal amount of space occupied
                                         * by data */
    ...
    u_int           itSize;
    u_int           itNumber;
    u_int           itKPD_Number;       /* number of Kernel Processed Data
                                         * entries */
    boolean_t       itInLine;
    boolean_t       itMigInLine;        /* MiG presents data as InLine,
                                         * although it is sent OOL */
    ...
    boolean_t       itNativePointer;    /* The user will pass a pointer to
                                         * the */
    /* native C type. */
    ...
    identifier_t    itBadValue; /* Excluded value for PointerToIfNot.  May be
                                 * NULL. */
}               ipc_type_t;
