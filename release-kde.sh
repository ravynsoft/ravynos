...
rm /usr/local/furybsd/iso/FuryBSD-12.1-KDE-${gitcheck}.iso >/dev/null 2>/dev/null || true
cd ${cwd} && ./build.sh kde ${gitcheck}
md5 /usr/local/furybsd/iso/FuryBSD-12.1-KDE-${gitcheck}.iso > /usr/local/furybsd/iso/FuryBSD-12.1-KDE-${gitcheck}.iso.md5
