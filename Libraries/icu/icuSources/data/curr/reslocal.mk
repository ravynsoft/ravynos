...
CURR_SOURCE_LOCAL = iu.txt ms_Arab.txt ms_Arab_BN.txt\
	...
	en_BR.txt en_CL.txt en_CN.txt en_CO.txt en_CZ.txt en_EE.txt en_ES.txt en_FR.txt\
	en_GR.txt en_HR.txt en_HU.txt en_ID.txt en_IS.txt\
	en_IT.txt en_JP.txt en_LT.txt en_LU.txt en_LV.txt\
	en_ME.txt en_MM.txt en_MV.txt en_MX.txt en_NO.txt en_PL.txt en_PT.txt\
	en_RO.txt en_RS.txt en_RU.txt en_SK.txt en_TH.txt en_TR.txt en_TW.txt en_UA.txt\
	...
	dv.txt gaa.txt gez_ER.txt gez.txt gn.txt\
	io.txt jbo.txt kaj.txt kcg.txt kpe_GN.txt\
	kpe.txt mni.txt moh.txt myv.txt nqo.txt\
	nr.txt nso.txt ny.txt oc.txt sa.txt\
	sc.txt scn.txt ss.txt st_LS.txt st.txt\
	syr.txt tig.txt tn_BW.txt tn.txt trv.txt\
	ts.txt ve.txt wa.txt wal.txt
