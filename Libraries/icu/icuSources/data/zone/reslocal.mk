...
ZONE_SOURCE_LOCAL = iu.txt ms_Arab.txt\
	...
	en_JP.txt en_LT.txt en_LU.txt en_LV.txt en_ME.txt en_MM.txt\
	en_NO.txt en_PL.txt en_PT.txt en_RO.txt en_RS.txt en_RU.txt\
	en_SK.txt en_TH.txt en_TR.txt en_TW.txt en_UA.txt\
