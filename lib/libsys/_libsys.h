...
typedef uint32_t (__sys_audit_session_self_t)(void);
typedef int (__sys_audit_session_join_t)(uint32_t);
typedef int (__sys_audit_session_port_t)(pid_t, void *);
...
typedef int (__sys_kevent64_t)(int, struct kevent64_s *, int, struct kevent64_s *, int, unsigned int, const struct timespec *);
...
typedef int (__sys_thr_create_t)(ucontext_t *, int *, int);
typedef void (__sys_thr_exit_t)(long *);
typedef int (__sys_thr_self_t)(int *);
typedef int (__sys_thr_kill_t)(int, int);
...
typedef int (__sys_thr_wake_t)(int);
...
typedef int (__sys_thr_set_name_t)(int, const char *);
typedef int (__sys_aio_fsync_t)(int, struct aiocb *);
typedef int (__sys_rtprio_thread_t)(int, lwpid_t, struct rtprio *);
typedef caddr_t (__sys_thr_stack_t)(size_t, size_t);
typedef int (__sys_thr_workq_t)(int, struct twq_param *);
...
typedef int (__sys_thr_kill2_t)(pid_t, int, int);
...
typedef int (__sys__kernelrpc_mach_vm_map_trap_t)(mach_port_name_t, mach_vm_offset_t *, mach_vm_size_t, mach_vm_offset_t, int, vm_prot_t);
typedef int (__sys__kernelrpc_mach_port_allocate_trap_t)(mach_port_name_t, mach_port_right_t, mach_port_name_t *);
typedef int (__sys__kernelrpc_mach_port_destroy_trap_t)(mach_port_name_t, mach_port_name_t);
typedef int (__sys__kernelrpc_mach_port_deallocate_trap_t)(mach_port_name_t, mach_port_name_t);
typedef int (__sys__kernelrpc_mach_port_mod_refs_trap_t)(mach_port_name_t, mach_port_name_t, mach_port_right_t, mach_port_delta_t);
typedef int (__sys__kernelrpc_mach_port_move_member_trap_t)(mach_port_name_t, mach_port_name_t, mach_port_name_t);
typedef int (__sys__kernelrpc_mach_port_insert_right_trap_t)(mach_port_name_t, mach_port_name_t, mach_port_name_t, mach_msg_type_name_t);
typedef int (__sys__kernelrpc_mach_port_insert_member_trap_t)(mach_port_name_t, mach_port_name_t, mach_port_name_t);
typedef int (__sys__kernelrpc_mach_port_extract_member_trap_t)(mach_port_name_t, mach_port_name_t, mach_port_name_t);
typedef int (__sys__kernelrpc_mach_port_construct_trap_t)(mach_port_name_t, struct mach_port_options *, uint64_t, mach_port_name_t *);
typedef int (__sys__kernelrpc_mach_port_destruct_trap_t)(mach_port_name_t, mach_port_name_t, mach_port_delta_t, uint64_t);
...
typedef int (__sys_mach_msg_trap_t)(mach_msg_header_t *, mach_msg_option_t, mach_msg_size_t, mach_msg_size_t, mach_port_name_t, mach_msg_timeout_t, mach_port_name_t);
typedef int (__sys_mach_msg_overwrite_trap_t)(mach_msg_header_t *, mach_msg_option_t, mach_msg_size_t, mach_msg_size_t, mach_port_name_t, mach_msg_timeout_t, mach_port_name_t, mach_msg_header_t *, mach_msg_size_t);
typedef int (__sys_semaphore_signal_trap_t)(mach_port_name_t);
typedef int (__sys_semaphore_signal_all_trap_t)(mach_port_name_t);
typedef int (__sys_semaphore_signal_thread_trap_t)(mach_port_name_t, mach_port_name_t);
...
typedef int (__sys_task_for_pid_t)(mach_port_name_t, int, mach_port_name_t *);
typedef int (__sys_pid_for_task_t)(mach_port_name_t, int *);
typedef int (__sys_macx_swapon_t)(char *, int, int, int);
typedef int (__sys_macx_swapoff_t)(char *, int);
typedef int (__sys_macx_triggers_t)(int, int, int, mach_port_name_t);
...
typedef int (__sys_thread_switch_t)(mach_port_name_t, int, mach_msg_timeout_t);
typedef int (__sys_clock_sleep_trap_t)(mach_port_name_t, mach_sleep_type_t, int, int, mach_timespec_t *);
...
typedef int (__sys_mk_timer_destroy_t)(mach_port_name_t);
typedef int (__sys_mk_timer_arm_t)(mach_port_name_t, mach_absolute_time_t);
typedef int (__sys_mk_timer_cancel_t)(mach_port_name_t, mach_absolute_time_t *);
...
uint32_t __sys_audit_session_self(void);
int __sys_audit_session_join(uint32_t port);
int __sys_audit_session_port(pid_t asid, void * portnamep);
...
int __sys_kevent64(int fd, struct kevent64_s * changelist, int nchanges, struct kevent64_s * eventlist, int nevents, unsigned int flags, const struct timespec * timeout);
...
int __sys_thr_create(ucontext_t * ctx, int * id, int flags);
void __sys_thr_exit(long * state);
int __sys_thr_self(int * id);
int __sys_thr_kill(int id, int sig);
...
int __sys_thr_set_name(int id, const char * name);
int __sys_aio_fsync(int op, struct aiocb * aiocbp);
int __sys_rtprio_thread(int function, lwpid_t lwpid, struct rtprio * rtp);
caddr_t __sys_thr_stack(size_t stacksize, size_t guardsize);
int __sys_thr_workq(int cmd, struct twq_param * args);
...
int __sys_thr_kill2(pid_t pid, int id, int sig);
...
int __sys__kernelrpc_mach_vm_map_trap(mach_port_name_t target, mach_vm_offset_t * address, mach_vm_size_t size, mach_vm_offset_t mask, int flags, vm_prot_t cur_protection);
int __sys__kernelrpc_mach_port_allocate_trap(mach_port_name_t target, mach_port_right_t right, mach_port_name_t * name);
int __sys__kernelrpc_mach_port_destroy_trap(mach_port_name_t target, mach_port_name_t name);
int __sys__kernelrpc_mach_port_deallocate_trap(mach_port_name_t target, mach_port_name_t name);
int __sys__kernelrpc_mach_port_mod_refs_trap(mach_port_name_t target, mach_port_name_t name, mach_port_right_t right, mach_port_delta_t delta);
int __sys__kernelrpc_mach_port_move_member_trap(mach_port_name_t target, mach_port_name_t member, mach_port_name_t after);
int __sys__kernelrpc_mach_port_insert_right_trap(mach_port_name_t target, mach_port_name_t name, mach_port_name_t poly, mach_msg_type_name_t polyPoly);
int __sys__kernelrpc_mach_port_insert_member_trap(mach_port_name_t target, mach_port_name_t name, mach_port_name_t pset);
int __sys__kernelrpc_mach_port_extract_member_trap(mach_port_name_t target, mach_port_name_t name, mach_port_name_t pset);
int __sys__kernelrpc_mach_port_construct_trap(mach_port_name_t target, struct mach_port_options * options, uint64_t context, mach_port_name_t * name);
int __sys__kernelrpc_mach_port_destruct_trap(mach_port_name_t target, mach_port_name_t name, mach_port_delta_t srdelta, uint64_t guard);
int __sys_mach_reply_port(void);
int __sys_thread_self_trap(void);
int __sys_task_self_trap(void);
int __sys_host_self_trap(void);
int __sys_mach_msg_trap(mach_msg_header_t * msg, mach_msg_option_t option, mach_msg_size_t send_size, mach_msg_size_t rcv_size, mach_port_name_t rcv_name, mach_msg_timeout_t timeout, mach_port_name_t notify);
int __sys_mach_msg_overwrite_trap(mach_msg_header_t * msg, mach_msg_option_t option, mach_msg_size_t send_size, mach_msg_size_t rcv_size, mach_port_name_t rcv_name, mach_msg_timeout_t timeout, mach_port_name_t notify, mach_msg_header_t * rcv_msg, mach_msg_size_t scatter_list_size);
int __sys_semaphore_signal_trap(mach_port_name_t signal_name);
int __sys_semaphore_signal_all_trap(mach_port_name_t signal_name);
int __sys_semaphore_signal_thread_trap(mach_port_name_t signal_name, mach_port_name_t thread);
int __sys_semaphore_wait_trap(mach_port_name_t wait_name);
int __sys_semaphore_wait_signal_trap(mach_port_name_t wait_name, mach_port_name_t signal_name);
int __sys_semaphore_timedwait_trap(mach_port_name_t wait_name, unsigned int sec, mach_clock_res_t nsec);
int __sys_semaphore_timedwait_signal_trap(mach_port_name_t wait_name, mach_port_name_t signal_name, unsigned int sec, mach_clock_res_t nsec);
int __sys__kernelrpc_mach_port_guard_trap(mach_port_name_t target, mach_port_name_t name, uint64_t guard, int strict);
int __sys__kernelrpc_mach_port_unguard_trap(mach_port_name_t target, mach_port_name_t name, uint64_t guard);
int __sys_task_name_for_pid(mach_port_name_t target_tport, int pid, mach_port_name_t * tn);
int __sys_task_for_pid(mach_port_name_t target_tport, int pid, mach_port_name_t * t);
int __sys_pid_for_task(mach_port_name_t t, int * pid);
int __sys_macx_swapon(char * name, int flags, int size, int priority);
int __sys_macx_swapoff(char * name, int flags);
int __sys_macx_triggers(int hi_water, int low_water, int flags, mach_port_name_t alert_port);
...
int __sys_thread_switch(mach_port_name_t thread_name, int option, mach_msg_timeout_t option_time);
int __sys_clock_sleep_trap(mach_port_name_t clock_name, mach_sleep_type_t sleep_type, int sleep_sec, int sleep_nsec, mach_timespec_t * wakeup_time);
...
int __sys_mk_timer_destroy(mach_port_name_t name);
int __sys_mk_timer_arm(mach_port_name_t name, mach_absolute_time_t expire_time);
int __sys_mk_timer_cancel(mach_port_name_t name, mach_absolute_time_t * result_time);
__END_DECLS
