...
![Base](https://api.cirrus-ci.com/github/mszoek/airyx.svg?branch=main&task=base_build) ![Packages](https://api.cirrus-ci.com/github/mszoek/airyx.svg?branch=main&task=ports_build) ![Airyx](https://api.cirrus-ci.com/github/mszoek/airyx.svg?branch=main&task=airyx_build)
