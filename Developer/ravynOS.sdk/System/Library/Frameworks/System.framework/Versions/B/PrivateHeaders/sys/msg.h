...
int msgsys(int, ...);
#endif  /* (!_POSIX_C_SOURCE || _DARWIN_C_SOURCE) */
#ifndef LIBC_ALIAS_MSGCTL
int msgctl(int, int, struct msqid_ds *) __DARWIN_ALIAS(msgctl);
#else /* LIBC_ALIAS_MSGCTL */
int msgctl(int, int, struct msqid_ds *) LIBC_ALIAS(msgctl);
#endif /* !LIBC_ALIAS_MSGCTL */
int msgget(key_t, int);
#ifndef LIBC_ALIAS_MSGRCV
ssize_t msgrcv(int, void *, size_t, long, int) __DARWIN_ALIAS_C(msgrcv);
#else /* LIBC_ALIAS_MSGRCV */
ssize_t msgrcv(int, void *, size_t, long, int) LIBC_ALIAS_C(msgrcv);
#endif /* !LIBC_ALIAS_MSGRCV */
#ifndef LIBC_ALIAS_MSGSND
int msgsnd(int, const void *, size_t, int) __DARWIN_ALIAS_C(msgsnd);
#else /* LIBC_ALIAS_MSGSND */
int msgsnd(int, const void *, size_t, int) LIBC_ALIAS_C(msgsnd);
#endif /* !LIBC_ALIAS_MSGSND */
__END_DECLS
